...
BMFH GetBMFH(const std::string& szFileNameIn);
BMIH GetBMIH(const std::string& szFileNameIn);
void DisplayBitmapInfo(const std::string& szFileNameIn);
int GetBitmapColorDepth(const std::string& szFileNameIn);
